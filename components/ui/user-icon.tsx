    ...
    >
      <g fill="none" className="nc-icon-wrapper">
        <path
          ...
          fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_0_y95s6luwt)"
          data-glass="origin"
          mask="url(#6u39acg2z4-1752500502811-1433248_users_mask_yf9omh5zt)"
        />
        <path
          d="M15.9414 10C19.8397 10.0001 22.9999 13.1603 23 17.0586C23 18.1307 22.1307 19 21.0586 19H9.94141C8.86932 19 8 18.1307 8 17.0586C8.00012 13.1603 11.1603 10.0001 15.0586 10H15.9414ZM15.5 1C17.433 1 19 2.567 19 4.5C19 6.433 17.433 8 15.5 8C13.567 8 12 6.433 12 4.5C12 2.567 13.567 1 15.5 1Z"
          fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_0_y95s6luwt)"
          data-glass="clone"
          filter="url(#6u39acg2z4-1752500502811-1433248_users_filter_3otwug04l)"
          clipPath="url(#6u39acg2z4-1752500502811-1433248_users_clipPath_bg1gnmpmw)"
        />
        <path
          ...
          fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_1_nqwjcp74f)"
          data-glass="blur"
        />
        <path
          ...
          fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_2_wnwbkzqj7)"
        />
        <path
          ...
          fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_3_let3hcao2)"
        />
        <defs>
          <linearGradient
            id="6u39acg2z4-1752500502811-1433248_users_existing_0_y95s6luwt"
            x1="15.5"
            y1="1"
            x2="15.5"
            y2="19"
          ...
          <linearGradient
            id="6u39acg2z4-1752500502811-1433248_users_existing_1_nqwjcp74f"
            x1="10"
            y1="2"
            x2="10"
            y2="22"
          ...
          >
            ...
            <stop offset="1" stopColor="rgba(187, 187, 192, 0.6)" data-glass-22="on" />
          </linearGradient>
          <linearGradient
            id="6u39acg2z4-1752500502811-1433248_users_existing_2_wnwbkzqj7"
            x1="10"
            y1="2"
            x2="10"
            y2="6.633"
          ...
          >
            ...
            <stop offset="1" stopColor="rgba(255, 255, 255, 1)" stopOpacity="0" data-glass-light="on" />
          </linearGradient>
          <linearGradient
            id="6u39acg2z4-1752500502811-1433248_users_existing_3_let3hcao2"
            x1="10"
            y1="12"
            x2="10"
            y2="17.791"
          ...
          <filter
            id="6u39acg2z4-1752500502811-1433248_users_filter_3otwug04l"
            x="-100%"
            y="-100%"
            width="400%"
            height="400%"
          ...
          <clipPath id="6u39acg2z4-1752500502811-1433248_users_clipPath_bg1gnmpmw">
            <path d="M10.3076 12C14.556 12 18 15.444 18 19.6924C18 20.9668 16.9668 22 15.6924 22H4.30762C3.03317 22 2.00004 20.9668 2 19.6924C2 15.444 5.44404 12 9.69238 12H10.3076ZM10 2C12.2091 2 14 3.79086 14 6C14 8.20914 12.2091 10 10 10C7.79086 10 6 8.20914 6 6C6 3.79086 7.79086 2 10 2Z" fill="url(#6u39acg2z4-1752500502811-1433248_users_existing_1_nqwjcp74f)" />
          </clipPath>
          <mask id="6u39acg2z4-1752500502811-1433248_users_mask_yf9omh5zt">
